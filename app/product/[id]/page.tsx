...
export default async function ProductPage({
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 lg:px-8 lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gapx-16">
      ...
      <div className="max-w-2xl mx-auto mt-5 lg:max-w-none lg:mt-0 lg:row-end-2 lg:col-span-3 lg:row-span-2">
          <h1 className="text-2xl font-extrabold tracking-tight text-gray-600 lg:text-3xl">{data?.name}</h1>
